...
import java.sql.*;
public class UserAuthenticationWithPreparedStatement {
...
String createTableSQL = "CREATE TABLE IF NOT EXISTS User3 (" +
...
String query = "SELECT * FROM User3 WHERE userId = ? AND passwordHash = ?";
